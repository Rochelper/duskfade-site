...
(function () {
  ...
  const T = {
    ...
    'hero.desc':        { en: 'In Duskfade, shatter the shackles of time as you jump, swing, and slash through a fantastic world. Zirian, accompanied by his mechanical Cuckoo, must save his sister from a mysterious Clock Tower that has plunged the land into eternal night.',
                          zh: '在《Duskfade》中打破时间的枷锁，于奇幻世界跳跃、摆荡、斩击。齐利安带着机械布谷鸟，必须从将大地拖入永夜的神秘钟楼中救出妹妹。',
                          ja: 'Duskfade で、時間の鎖を打ち砕き、幻想的な世界を駆け抜けろ。ジリアンは機械仕掛けのカッコウと共に、大地を永遠の夜に沈めた謎の時計塔から妹を救い出さなければならない。',
                          es: 'En Duskfade, rompe las cadenas del tiempo mientras saltas, balanceas y luchas a través de un mundo fantástico. Zirian, acompañado por su cuco mecánico, debe salvar a su hermana de una misteriosa Torre del Reloj que ha sumido la tierra en una noche eterna.' },
    ...
    'hub.kw2_d':            { en: 'Every boss fight with phase-by-phase tactics and counter windows.',
    ...
    'scn2.p':               { en: 'Wrath, Guayota, Sadness, The Watcher, Despair — phase-by-phase counters.',
                              zh: '愤怒、悲伤、恐惧、嫉妒、绝望 —— 分阶段克制。',
                              ja: 'Wrath、Sorrow、Fear、Jealousy、Despair — フェーズ別対策。',
                              es: 'Wrath, Guayota, Sadness, The Watcher, Despair — contraataques por fase.' },
    ...
    'card2.desc':  { en: 'Every boss fight with phase-by-phase tactics: Wrath, Guayota, Sadness, The Watcher, Despair.',
                     zh: '全部 5 个 Boss 分阶段攻略：愤怒、悲伤、恐惧、嫉妒、绝望。',
                     ja: '全5ボスのフェーズ別攻略：Wrath、Sorrow、Fear、Jealousy、Despair。',
                     es: 'Los 5 jefes con tácticas por fases: Wrath, Guayota, Sadness, The Watcher, Despair.' },
    ...
    'ph.boss.desc':        { en: 'Every boss fight with phase-by-phase tactics', zh: '全部 Boss 分阶段攻略', ja: '全ボスのフェーズ別攻略', es: 'Todos los jefes con tácticas por fases' },
    ...
    'ph.demo.desc':        { en: 'Free Steam + PS5 demo — 60-90 min of clockpunk platforming, 5 areas, 2 abilities, and a full Wrath boss fight.', zh: '免费的 Steam + PS5 Demo —— 60-90 分钟钟表朋克平台跳跃、5 个区域、2 个能力，以及一场完整的 Wrath Boss 战。', ja: '無料の Steam + PS5 デモ — 60〜90 分のクロックパンク・アクション、5 エリア、2 アビリティ、そして Wrath ボス戦。', es: 'Demo gratuita de Steam + PS5 — 60-90 min de plataformas clockpunk, 5 zonas, 2 habilidades y una pelea completa contra Wrath.' },
    'ph.review.title':     { en: 'Duskfade Review',           zh: 'Duskfade 评测',       ja: 'Duskfade レビュー',    es: 'Análisis de Duskfade' },
    'ph.review.desc':      { en: 'Media scores, Steam player feedback, pros & cons, and our verdict on the clockpunk 3D action platformer.', zh: '媒体评分、Steam 玩家反馈、优缺点，以及我们对这款钟表朋克 3D 动作平台游戏的终极评价。', ja: 'メディアスコア、Steam プレイヤーの声、長所短所、そして時計朋克 3D アクションプラットフォーマーの評価。', es: 'Puntuaciones de la prensa, opiniones de jugadores de Steam, pros y contras y nuestro veredicto del plataformas 3D clockpunk.' },
    ...
    'ph.lore.desc':         { en: 'The eternal night, the Clock Tower, and the bosses standing between Zirian and Allira.', zh: '永恒之夜、钟楼，以及挡在齐利安与阿莉拉之间的各位 Boss。', ja: '永遠の夜、時計塔、そしてジリアンとアリーラの間に立ちはだかるボスたち。', es: 'La noche eterna, la Torre del Reloj y los jefes que se interponen entre Zirian y Allira.' },
    ...
    /* ===== VERIFIED BOSSES & 100% GUIDE (Aug 2026 fact-check pass) ===== */
    'ph.guayota.title':    { en: 'Guayota — Boss Guide',    zh: 'Guayota — Boss 攻略',   ja: 'グアヨタ — ボス攻略',      es: 'Guayota — Guía de Jefe' },
    'ph.guayota.desc':     { en: 'The Volcano Path finale in the Prison of the Beast — lava floods, grapple chains and the first chain broken.', zh: '火山之路的终局之战，位于野兽监狱——熔岩淹没、钩爪拉链，以及第一条锁链的断裂。', ja: 'ボルケーノ・パスの最終ボス、獣の牢獄にて — 溶岩の氾濫、グラップルの鎖、そして最初の鎖の解放。', es: 'El final del Camino del Volcán en la Prisión de la Bestia — inundaciones de lava, cadenas de garfio y la primera cadena rota.' },
    'ph.sadness.title':    { en: 'Sadness — Boss Guide',    zh: 'Sadness — Boss 攻略',   ja: 'サッドネス — ボス攻略',    es: 'Sadness — Guía de Jefe' },
    'ph.sadness.desc':     { en: 'Three bubble-shield phases, clock breaks and the spin-into-dizzy punish window.', zh: '三段泡泡护盾、打破时钟与旋转后的眩晕惩罚窗口。', ja: '3つのバブルシールド、時計の破壊、そして回転後のめまい状態への追撃。', es: 'Tres fases de escudo de burbuja, rotura de relojes y la ventana de castigo tras el giro.' },
    'ph.watcher.title':    { en: 'The Watcher — Boss Guide', zh: 'The Watcher — Boss 攻略', ja: 'ザ・ウォッチャー — ボス攻略', es: 'El Vigilante — Guía de Jefe' },
    'ph.watcher.desc':     { en: 'Laser counters, the red force-field pylon route and heavy-attack shield breaks.', zh: '激光应对、红色力场塔柱路线，以及重击破盾。', ja: 'レーザー対策、赤いフォースフィールドのパイロンルート、そして強攻撃でのシールド破壊。', es: 'Contraataques láser, la ruta de pilones del campo de fuerza rojo y rotura de escudos con ataques pesados.' },
    'ph.full.title':       { en: '100% Completion Guide',   zh: '100% 完成指南',         ja: '100% コンプリートガイド',   es: 'Guía de 100%' },
    'ph.full.desc':        { en: 'Region order, the full collectible checklist, ability gates and the efficient post-story sweep.', zh: '区域顺序、完整收集清单、能力门槛与高效的通关后清扫路线。', ja: 'エリア順、完全収集チェックリスト、アビリティ条件、効率的なクリア後回収ルート。', es: 'Orden de regiones, lista completa de coleccionables, requisitos de habilidades y la ruta eficiente tras la historia.' },
